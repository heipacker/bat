...
import com.dlmu.bat.client.concurrent.TraceCallable;
import com.dlmu.bat.client.concurrent.TraceExecutorService;
import com.dlmu.bat.client.concurrent.TraceRunnable;
...
public class DTraceClient implements Closeable {
    ...
    public TraceScope newScope(String description, TraceInfo traceInfo) {
        return newScope(description, SpanId.INVALID);
    }
