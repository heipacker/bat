...
public class TraceConfigParser {
    ...
    public Map<String, TraceClass> parse(BufferedReader lineReader) throws IOException {
        Map<String, TraceClass> classes = new HashMap<String, TraceClass>();
        String line;
        while ((line = lineReader.readLine()) != null) {
            try {
                ...
                TraceClass traceClass = classes.get(className);
                if (traceClass == null) {
                    traceClass = new TraceClass(className);
                    classes.put(className, traceClass);
                }
