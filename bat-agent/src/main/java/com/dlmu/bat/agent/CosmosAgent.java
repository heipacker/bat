...
/**
 * <p>
 * The Byte Buddy agent provides a JVM {@link java.lang.instrument.Instrumentation} in order to allow Cosmos the
 ...
 * <p>
 * <code>
 * java -javaagent:agent-tools.jar -jar app.jar
 * </code>
 * </p>
 * <p>
 * <b>Note</b>: The runtime installation of a Java agent is not possible on all JVMs. See the documentation for
 * {@link CosmosAgent#install()} for details on JVMs that are supported out of the box.
 * </p>
 * <p>
 * <b>Important</b>: This class's name is known to the Cosmos main application and must not be altered.
 * </p>
 */
public class CosmosAgent {
    ...
    /**
     * The default prefix of the Cosmos agent jar file.
     */
    private static final String AGENT_FILE_NAME = "cosmosAgent";
     ...
     * such that subsequently to an installation, {@link CosmosAgent#getInstrumentation()} should
     * be invoked instead.
     * </p>
     *
    ...
    /**
     * Performs the actual installation of the Cosmos agent.
     *
    ...
    /**
     * Saves all necessary classes for the Cosmos agent jar to the given file.
     *
    ...
    private static void saveAgentJar(File agentFile) throws Exception {
        InputStream inputStream = AgentInstaller.class.getResourceAsStream('/' + AgentInstaller.class.getName().replace('.', '/') + CLASS_FILE_EXTENSION);
        if (inputStream == null) {
            throw new IllegalStateException("Cannot locate class file for Cosmos installer");
        }
        try {
            Manifest manifest = new Manifest();
            manifest.getMainAttributes().put(Attributes.Name.MANIFEST_VERSION, MANIFEST_VERSION_VALUE);
            manifest.getMainAttributes().put(new Attributes.Name(AGENT_CLASS_PROPERTY), AgentInstaller.class.getName());
            ...
            try {
                jarOutputStream.putNextEntry(new JarEntry(AgentInstaller.class.getName().replace('.', '/') + CLASS_FILE_EXTENSION));
    ...
    /**
     * <p>
     * Looks up the {@link java.lang.instrument.Instrumentation} instance of an installed Cosmos agent. Note that
     ...
     * </p>
     * <p>
     * <b>Note</b>: This method throws an {@link IllegalStateException} If the Cosmos agent is not
     * properly installed.
     * </p>
     *
    ...
    public static Instrumentation getInstrumentation() {
        Instrumentation instrumentation = doGetInstrumentation();
        if (instrumentation == null) {
            throw new IllegalStateException("The Cosmos agent is not initialized");
        }
        return instrumentation;
    }
     ...
     * Cosmos agent.
     *
     * @return The Cosmos agent's {@link java.lang.instrument.Instrumentation} instance.
     */
    ...
    public interface AttachmentProvider {
        ...
        interface Accessor {
            ...
            enum Unavailable implements Accessor {
                ...
                public String toString() {
                    return "CosmosAgent.AttachmentProvider.Accessor.Unavailable." + name();
                }
            }
            ...
            class Simple implements Accessor {
                ...
                @Override
                public String toString() {
                    return "CosmosAgent.AttachmentProvider.Accessor.Simple{" +
                ...
                protected interface Dispatcher {
                    ...
                    enum ForLegacyVm implements Dispatcher {
                        ...
                        @Override
                        public String toString() {
                            return "CosmosAgent.AttachmentProvider.Accessor.Simple.Dispatcher.ForLegacyVm." + name();
                        }
                    }
                    ...
                    class ForJava9CapableVm implements Dispatcher {
                        ...
                        @Override
                        public String toString() {
                            return "CosmosAgent.AttachmentProvider.Accessor.Simple.Dispatcher.ForJava9CapableVm{" +
                                    "current=" + current +
                                    ", getPid=" + getPid +
                                    '}';
                        }
        ...
        enum ForJigsawVm implements AttachmentProvider {
            ...
            @Override
            public String toString() {
                return "CosmosAgent.AttachmentProvider.ForJigsawVm." + name();
            }
        }
        ...
        enum ForJ9Vm implements AttachmentProvider {
            ...
            @Override
            public String toString() {
                return "CosmosAgent.AttachmentProvider.ForJ9Vm." + name();
            }
        }
        ...
        enum ForToolsJarVm implements AttachmentProvider {
            ...
            @Override
            public String toString() {
                return "CosmosAgent.AttachmentProvider.ForToolsJarVm." + name();
            }
            ...
            protected static class ClassLoaderCreationAction implements PrivilegedAction<ClassLoader> {
                ...
                @Override
                public String toString() {
                    return "CosmosAgent.AttachmentProvider.ForToolsJarVm.ClassLoaderCreationAction{" +
                            "toolsJar=" + toolsJar +
                            '}';
                }
            }
        ...
        class Compound implements AttachmentProvider {
            ...
            @Override
            public String toString() {
                return "CosmosAgent.AttachmentProvider.Compound{" +
