...
import com.dlmu.agent.server.tclass.TraceArg;
import com.dlmu.agent.server.tclass.TraceField;
import com.dlmu.agent.server.tclass.TraceMethod;
import com.dlmu.agent.server.tclass.Wrapper;
...
class TraceMethodVisitor extends MethodVisitor implements Opcodes {
    ...
    private void emitCatchBlocks(int scopeVarIndex, Label[] exceptionHandlers) {
        ...
        for (int i = 0; i < newExceptionsLen; i++) {
            ...
            traceMethod.visitMethodInsn(INVOKEINTERFACE, QTRACE_SCOPE_INTERNALNAME, "addAnnotation", "(Ljava/lang/String;Ljava/lang/String;)V", true);
    ...
    private void startTrace(int scopeVarIndex) {
        ...
        //scope.addAnnotation(Constants.TRACE_TYPE,method.getType);
    ...
    private void invokeAddKVAnnotation(String desc) {
        ...
        traceMethod.visitMethodInsn(INVOKESTATIC, TRACEUTILS_INTERNALNAME, "addKVAnnotation", addKVAnnotationDesc, false);
    }
